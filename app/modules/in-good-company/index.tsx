              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`max-w-[28em] h-[100px]  flex items-center justify-center text-center md:text-[12px] text-white text-[10px] md:font-normal font-normal ${inter.className}`}
                    >
                      {testimonial.text}
                    </p>
                    <p
                      className={`text-white text-sm h-[40px]  break-words max-w-[200px] text-center ${inter.className}`}
                    >
                      {testimonial.name}
                    </p>
                  </div>
